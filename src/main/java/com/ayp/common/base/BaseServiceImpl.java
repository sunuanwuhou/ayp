package com.ayp.common.base;


import com.ayp.common.context.SpringContextUtil;
...
//        try {
//            Method selectByExampleWithBLOBs = dao.getClass().getDeclaredMethod("selectByExampleWithBLOBs", example.getClass());
//            Object result = selectByExampleWithBLOBs.invoke(dao, example);
...
//
//            Method selectByExampleWithBLOBs = dao.getClass().getDeclaredMethod("selectByExampleWithBLOBs", example.getClass());
//            List<Record> result = (List<Record>) selectByExampleWithBLOBs.invoke(dao, example);
//            if (null != result && result.size() > 0) {
//                return result.get(0);
//            }
//        } catch (IllegalAccessException e) {
...
//        try {
//            Method updateByExampleWithBLOBs = dao.getClass().getDeclaredMethod("updateByExampleWithBLOBs", record.getClass(), example.getClass());
//            Object result = updateByExampleWithBLOBs.invoke(dao, record, example);
//            return Integer.parseInt(String.valueOf(result));
//        } catch (IllegalAccessException e) {
//            e.printStackTrace();
//        } catch (InvocationTargetException e) {
...
//        try {
//            Method updateByPrimaryKeyWithBLOBs = dao.getClass().getDeclaredMethod("updateByPrimaryKeyWithBLOBs", record.getClass());
//            Object result = updateByPrimaryKeyWithBLOBs.invoke(dao, record);
//            return Integer.parseInt(String.valueOf(result));
//        } catch (IllegalAccessException e) {
//            e.printStackTrace();
//        } catch (InvocationTargetException e) {
